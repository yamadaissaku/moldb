...
if (isset($_POST["login"])) {
	...
	} else if (empty($_POST["username"])) {  // emptyは値が空のとき
	...
	<body>
		...
		<form id="loginForm" name="loginForm" action="" method="POST">
			<fieldset>  <!-- fieldsetはグループ化してくれる(線で囲ってくれる) -->
				...
				<label for="userid">ユーザーID</label><input type="text" id="userid" name="userid" placeholder="ユーザーIDを入力" value="<?php if (!empty($_POST["userid"])) {echo htmlspecialchars($_POST["userid"], ENT_QUOTES);} ?>">  <!-- 初回起動はユーザー名空白にして、２回目以降はPOST送信したユーザーIDが保存されている。 -->
				<br>
